      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job Sadan</h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="guptasomitra@gmail.com" className="hover:text-gray-400" aria-label="Gmail">
            ...
            <a href="github.com/Somitraa" className="hover:text-gray-400" aria-label="Github">
            ...
            <a href="https://linkedin.com/in/somitra-gupta-775b86260/" className="hover:text-gray-400" aria-label="LinkedIn">
